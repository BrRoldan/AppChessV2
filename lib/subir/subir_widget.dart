...
import 'subir_model.dart';
export 'subir_model.dart';

class SubirWidget extends StatefulWidget {
  const SubirWidget({super.key});

  @override
  State<SubirWidget> createState() => _SubirWidgetState();
}

class _SubirWidgetState extends State<SubirWidget> {
  late SubirModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SubirModel());
                        ...
                        children: [
                          Padding(
                            ...
                            child: ClipRRect(
                              borderRadius: BorderRadius.circular(8.0),
                              child: Image.asset(
                                'assets/images/1485476049-artboard-1_78529.png',
                                width: 50.0,
                                height: 50.0,
                                fit: BoxFit.cover,
                              ),
                      ...
                      child: Column(
                        ...
                        children: [
                          InkWell(
                            ...
                            highlightColor: Colors.transparent,
                            onTap: () async {
                              await DocumentoRecord.collection.doc().set({
                                ...createDocumentoRecordData(
                                  nombre: _model.textController4.text,
